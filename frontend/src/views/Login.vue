    ...
    <v-row>
      <v-col xl="4" md="6" sm="12" class="mx-auto">
        <form @keyup.enter.native="login" class="pa-5">
          <v-text-field label="Username or Email" v-model="username" required focused variant="outlined"></v-text-field>
          <v-text-field label="Password" v-model="password" required variant="outlined" type="password"></v-text-field>
