...
export type OwnerAssignmentsFragmentFragment = { members: Array<{ id: string, username: string }>, assignments: Array<(
    { id: string, name: string, dueAt?: any | null, content: string, files: Array<{ id: string, name: string }>, submissions: Array<{ id: string, createdAt: any, updatedAt?: any | null, user: { id: string, username: string }, files: Array<{ id: string, name: string }> }> }
...
export type AssignmentSubmissionsQueryQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type AssignmentSubmissionsQueryQuery = { assignmentSubmissions?: Array<{ id: string, createdAt: any, updatedAt?: any | null, user: { id: string, username: string }, files: Array<{ id: string, name: string }> }> | null };
...
export type AssignmentFragmentFragment = { id: string, name: string, content: string, dueAt?: any | null, submissions: Array<{ id: string, createdAt: any, updatedAt?: any | null, user: { id: string, username: string }, files: Array<{ id: string, name: string }> }> } & { ' $fragmentName'?: 'AssignmentFragmentFragment' };
...
export const AssignmentSubmissionsQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AssignmentSubmissionsQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"assignmentSubmissions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"assignmentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"files"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<AssignmentSubmissionsQueryQuery, AssignmentSubmissionsQueryQueryVariables>;
