...
export type ClassResourceCreate = Assignment | Channel | File;

export type ClassResourceDelete = AssignmentDeleteInfo | ChannelDeleteInfo | FileDeleteInfo;

export type ClassResourceUpdate = Channel | Class;
...
export type Mutation = {
  ...
  joinClass: Scalars['Boolean']['output'];
  login: LoginResult;
...
export type ClassClassByIdQueryQuery = { classById?: (
    { name: string }
    & { ' $fragmentRefs'?: { 'ChatFragmentFragment': ChatFragmentFragment;'FilesFragmentFragment': FilesFragmentFragment;'AssignmentsFragmentFragment': AssignmentsFragmentFragment;'MeetingFragmentFragment': MeetingFragmentFragment } }
  ) | null };
...
export type ClassResourceDeletedSubscriptionSubscription = { classResourceDeleted: { __typename: 'AssignmentDeleteInfo', id: string } | { __typename: 'ChannelDeleteInfo', id: string } | { __typename: 'FileDeleteInfo', id: string } };
